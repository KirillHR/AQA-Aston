...
public class TestClass {
    ...
    @Description("Тест проверяет, что заголовок страницы правильный")
    ...
    @Description("Тест проверяет, что все логотипы на странице отображаются корректно")
    @Severity(SeverityLevel.NORMAL)
    ...
    @Description("Тест проверяет, что ссылка на странице работает корректно")
    ...
    @Description("Тест проверяет, что все поля формы работают корректно")
    @Severity(SeverityLevel.NORMAL)
    ...
    @Description("Тест проверяет правильность отображения плейсхолдеров в формах на странице")
    @Severity(SeverityLevel.NORMAL)
    ...
    @Description("Тест проверяет, что элементы окна оплаты отображаются корректно")
